            ...
            <div className="main__block">
              <div className="main__content">
                ...
                <div className="main__column column">
                  ...
                  {/* Тут начинается колонки чисто колнки */}

                  <div className="cards">
                    {/* Первый блок с компонентом */}
                    <div>
